...
- [ ] 8. There is a single point of failure at the federal and state level. The Department of State will be deluged with passport applications. In South Carolina, Vital Records is the choke point. It is like attempting to use a funnel to direct water from a firehose.
- [(202) 224-5972 *3 – Graham, Lindsey (T-SC)](tel:+12022245972)
    - [x] Spoke to staffer
    - [ ] Left voicemail
    - [ ] Line busy / try again
