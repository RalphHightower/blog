...
BEGIN {
    ...
    # 1. add <> ETF symbols
    #
    etfAmericasSymbols = "SPY|DIA|QQQ|IWM|IJR|IJH|VTI|VOO|VT|RSP|MDY|SMH|SOXX|XLF|XLI|XLE|XLK|XLY|XLP|XLU|XLB|XLC|XOP|XES|XME|EWC|EWW|EWZ|EWP|EPU|ECH|EWA|EWO|"
    
    etfEMEASymbols = "VGK|IEUR|FEZ|FEP|EWG|EWU|EWQ|EWL|EWD|EWN|EWI|EWP|EWO|EZA|AFK|MES|GULF|UAE|QAT|TUR|PLND|GREK|NORW|ISRA|SAUD|"
    
    etfAsiaPacificSymbols = "AAXJ|VPL|EPP|EEM|EMXC|EWJ|DXJ|FXI|MCHI|KWEB|INDA|PIN|EPI|EPHE|EWT|EWY|EWA|EWH|EWS|EIDO|ASHR|KGRN|AIA|"
    
    etfDefenseSymbols = "ARKQ|ARKX|DFEN|EUAD|FITE|GCAD|IDEF|ITA|JEDI|KDEF|MISL|NATO|PPA|SHLD|UFO|WAR|WDAF|WDEF|WDGF|XAR|"

    etfEnergySymbols = "|AMLP|AMZA|BNO|BOIL|BWET|CCNR|CRAK|CSNR|DBO|DIG|DRIP|DUG|EINC|EIPI|EMLP|ENFR|ERX|ERY|FCG|FENY|FTRI|FTXN|FUTY|FXM|FXU|GII|GNR|GUNR|GUSH|IDU|IEO|IEZ|IFRA|IGF|IXC|IYE|JXI|KOLD|MLPX|NANR|NFRA|NLR|NRGD|NRGU|OIH|OILD|OILK|OILT|OILU|PSCE|PUI|PXE|PXI|PXJ|RBLD|RSPG|RSPU|SCO|TEXU|TOLZ|TPYP|UCO|UGA|UMI|UNG|UPW|URA|URNG|URNM|USAI|USL|USO|USOY|UTES|UTSL|VDE|VPU|XES|XLE|XLU|XOP|"
# URNJ|NUKZ
